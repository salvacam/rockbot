...
ipk: $(TARGET)
	...
	@cp -r rockbot/rockbot.dge rockbot/rockbot.png rockbot/fonts rockbot/games rockbot/packages rockbot/shared rockbot/template /tmp/.rockbot-ipk/root/home/retrofw/games/rockbot
	@cp rockbot/rockbot.lnk /tmp/.rockbot-ipk/root/home/retrofw/apps/gmenu2x/sections/games
	@sed "s/^Version:.*/Version: $$(date +%Y%m%d)/" rockbot/control > /tmp/.rockbot-ipk/control
	@cp rockbot/conffiles /tmp/.rockbot-ipk/
	...
	@ar r rockbot/rockbot.ipk /tmp/.rockbot-ipk/control.tar.gz /tmp/.rockbot-ipk/data.tar.gz /tmp/.rockbot-ipk/debian-binary

opk: $(TARGET)
	@mksquashfs \
	rockbot/default.retrofw.desktop \
	rockbot/rockbot.dge \
	rockbot/rockbot.png \
	rockbot/fonts \
	rockbot/games \
